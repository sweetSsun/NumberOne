               ...
               <tbody id="bdListTbody">
	               <c:forEach items="${usedBoardList }" var="usedBoard">
	                   ...
	                   <tr style="border-bottom: solid #E0E0E0 1px;">
	                      ...
	                      <td class="text-center overflow pointer" onclick="writeMemberBoard('${usedBoard.ubnickname}')">${usedBoard.ubnickname}</td>
			...
			$.ajax({
				...
				success: function(result){
					...
					for (var i = 0; i < result.length; i++){
						...
						output += "<td class='text-center overflow pointer' onclick='writeMemberBoard(\"" + result[i].ubnickname + "\")'>" + result[i].ubnickname + "</td>";
