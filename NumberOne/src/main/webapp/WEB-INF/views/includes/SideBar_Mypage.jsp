		...
		<div id="sideclose">
			<div class="sidemenu" style="color: white;">
				...
				<div class="sideclose_room">
					<span>
						<a href="selectMyInfoCommunityView#scroll-board"><i class="fa-solid fa-pencil"></i></a>
					</span>
				</div>
				<div class="sideclose_room">
					<span>
						<a href="selectMyInfoCommunityView#scroll-reply"><i class="fa-brands fa-replyd"></i></a>
					</span>
				</div>
				<div class="sideclose_room">
					<span>
						<a href="selectMyInfoCommunityView#scroll-scrap"><i class="fa-solid fa-star"></i></a>
					</span>
				</div>
				<div class="sideclose_room">
					<span>
						<a href="selectMyInfoResellView#scroll-sellbuy"><i class="fa-solid fa-carrot"></i></a>
					</span>
				</div>
				<div class="sideclose_room">
					<span>
