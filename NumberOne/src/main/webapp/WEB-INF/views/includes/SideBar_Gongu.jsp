		...
		<div id="sideclose">
			<div class="sidemenu" style="color: white;">
				...
				<div class="sideclose_room">
					<span>
						<a href="selectGonguBoardList?NbCheck=GB" title="진행중"><i class="fa-solid fa-box-open"></i></a>
					</span>
				</div>
				<div class="sideclose_room">
					<span>
						<a href="selectGonguBoardList?NbCheck=GB" title="진행완료"><i class="fa-solid fa-box"></i></a>
					</span>
				</div>
			</div>
		...
		<div id="sideList">
			...
			<div class="sidemenu">
				...
				<div class="sideroom" style="margin-bottom: 15px;">
					<span>
						<a href="selectGonguBoardList?NbCheck=GB"><i class="fa-solid fa-box-open"></i>&nbsp;&nbsp;진행중</a>
					</span>
				</div>
				<div class="sideroom">
					<span>
						<a href="selectGonguBoardList?NbCheck=GB"><i class="fa-solid fa-box" style="font-size: x-large"></i>&nbsp;&nbsp;진행완료</a>
					</span>
				</div>
			</div>
