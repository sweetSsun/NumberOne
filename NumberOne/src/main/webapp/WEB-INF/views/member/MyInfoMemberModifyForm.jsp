                        ...
                        <c:otherwise>
                            <div class="row">
                                <div class="col-lg-6 col-md-12 col-sm-12">
                                    <div class="checkout__input">
                                        <p>비밀번호<span>*</span></p>
                                        <input type="password" placeholder="영문&숫자 6~20자로 입력해주세요." id="inputMpw" name="mpw"  value="${memberInfo.mpw }">
									<span id="pwCheckMsg" class="msg"></span>                                      
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-12 col-sm-12">
                        ...
                        <!-- 닉네임 , 성별 -->
                            ...
                            <!-- 전화번호 -->
                                ...
                                <div class="col-lg-6 col-md-12 col-sm-12">
                                    <div class="checkout__input">
                                        <p>전화번호<span>*</span></p>
                                        <input type="text" id="inputMphone" name="mphone" placeholder="'-' 포함하여 번호 입력해주세요."  value="${memberInfo.mphone }" onKeyup="this.value=this.value.replace(/[^-0-9]/g,'');"/>
